...
function Aboutme() {
  return (
  <div data-aos='fade-up' className='mt-55 relative container mx-auto font-mono mb-30 flex flex-col items-center sm:flex-row sm:justify-center sm:items-center'>
    ...
    <div className='text-center flex items-center sm:pt-0 text-blue-200 lg:w-150 sm:w-115'>
      <ul className='px-10 space-y-8 lg:text-end sm:text-end text-center lg:text-4xl text-3xl'>
