...
function Navbar() {
  ...
  return (
    <div className='px-7 flex justify-between sticky top-0 z-150 py-3 backdrop-blur-lg'>
      ...
      <div>
        ...
        <div data-aos='fade-up' className='text-neutral-800 fixed top-0 left-0 z-50 bg-pink-100 h-screen w-screen space-y-18'>
          ...
          <ul className='pt-35 text-center space-y-15 text-4xl lg:text-5xl'>
            ...
            <li className='hover:text-blue-300 cursor-pointer'><a href='https://drive.google.com/file/d/1pmkOkNW1e1dOgnGI6UOvH-2eps4aGBG7/view?usp=sharing' target='_blank'>RESUME</a></li>
